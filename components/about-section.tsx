...
const aboutContent = {
  ...
  projects: {
    ...
    text: "Nuestro enfoque en la gestion de proyectos de ingenieria combina precision tecnica con vision estrategica. Cada proyecto es una oportunidad para demostrar nuestro compromiso con la excelencia, asegurando que cada etapa se ejecute con los mas altos estandares de calidad, seguridad y eficiencia.",
    color: "#00A8FF",
    icon: Building2,
    highlights: [
      { icon: Building2, label: "Ingenieria", desc: "Precision tecnica en cada proyecto" },
      { icon: Target, label: "Excelencia", desc: "Altos estandares de calidad" },
      { icon: Shield, label: "Seguridad", desc: "Compromiso con la seguridad total" },
    ],
  ...
  taxlegal: {
    ...
    text: "Brindamos asesoramiento fiscal y juridico integral, combinando conocimiento profundo con un enfoque moderno y estrategico. Nuestro equipo de profesionales se dedica a proteger los intereses de nuestros clientes, ofreciendo soluciones personalizadas que se adaptan a las necesidades especificas de cada caso.",
    color: "#F9105E",
    icon: Scale,
    highlights: [
      { icon: Scale, label: "Fiscal & Juridico", desc: "Asesoramiento integral y especializado" },
      { icon: Briefcase, label: "Personalizado", desc: "Soluciones adaptadas a cada caso" },
      { icon: Shield, label: "Proteccion", desc: "Velamos por tus intereses" },
    ],
    image: "/images/task-woman.png",
    bulletPoints: [
      "Planeacion fiscal estrategica",
      "Proteccion juridica completa",
